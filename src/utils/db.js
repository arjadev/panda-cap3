export const DB = {
    ...
    myResum : [
        {
            title: 'Python Django and React js development',
            calendar: '2015 - 2016',
            description: 'I have developed event management system in Canada, USA stock trading platform etc using React js and Django.'
        },
        {
            title: 'React js & Java SpringBoot development',
            calendar: '2017 - 2018',
    ...
    myProjects: [
        ...
        {name:'Desert', skill: 'Django', img: 'img/portfolio/img-3.jpg'},
        {name:'Toy Story', skill: 'PHP', img: 'img/portfolio/img-4.jpg'},
